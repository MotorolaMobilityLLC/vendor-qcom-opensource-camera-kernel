...
#endif
#ifdef CONFIG_MOT_SM6475_LAMY
#include "include/cam_csiphy_1_2_3_hwreg_lamy.h"
#endif
#endif
...
#ifdef CONFIG_MOT_CUSTOM_CTLE_PARAM
#if defined(CONFIG_MOT_SM7435_AVATRN) || defined(CONFIG_MOT_SM6450_CUSCO) || defined(CONFIG_MOT_SM6475_MONA) || defined(CONFIG_MOT_SM6475_LAMY)
		if (soc_info->index == 1) {
