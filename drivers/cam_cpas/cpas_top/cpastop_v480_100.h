...
static struct cam_camnoc_niu
	...
	},
	{
		...
		.maxwrclr_low = {
			...
			.access_type = CAM_REG_TYPE_WRITE,
			.masked_value = 0,
			.offset = 0x2828, /* IPE_BPS_WR_MAXWRCLR_LOW */
			.value = 0x1,
		},
	},
	{
		...
		.maxwrclr_low = {
			...
			.access_type = CAM_REG_TYPE_WRITE,
			.masked_value = 0,
			.offset = 0x2E28, /* JPEG_MAXWRCLR_LOW */
			.value = 0x1,
		},
	},
	{
...
static struct cam_camnoc_info cam480_cpas100_camnoc_info = {
	.niu = &cam_cpas_v480_100_camnoc_niu[0],
	.num_nius = ARRAY_SIZE(cam_cpas_v480_100_camnoc_niu),
