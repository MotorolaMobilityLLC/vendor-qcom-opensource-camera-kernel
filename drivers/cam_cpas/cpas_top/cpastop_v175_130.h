...
static struct cam_camnoc_niu
	...
	},
	{
		...
		.maxwrclr_low = {
			...
			.access_type = CAM_REG_TYPE_WRITE,
			.masked_value = 0,
			.offset = 0x3628, /* IFE0123_MAXWRCLR_LOW */
			.value = 0x1,
		},
	},
	{
		...
		.maxwrclr_low = {
			...
			.access_type = CAM_REG_TYPE_WRITE,
			.masked_value = 0,
			.offset = 0x3A28, /* IFE0_MAXWRCLR_LOW */
			.value = 0x1,
		},
	},
	{
	...
	},
	{
		...
		.maxwrclr_low = {
			...
			.access_type = CAM_REG_TYPE_WRITE,
			.masked_value = 0,
			.offset = 0x5428, /* IFE1_MAXWRCLR_LOW */
			.value = 0x1,
		},
	},
	{
	...
	},
	{
		...
		.maxwrclr_low = {
			...
			.access_type = CAM_REG_TYPE_WRITE,
			.masked_value = 0,
			.offset = 0x5E28, /* IPE_VID_DISP_MAXWRCLR_LOW */
			.value = 0x1,
		},
	},
