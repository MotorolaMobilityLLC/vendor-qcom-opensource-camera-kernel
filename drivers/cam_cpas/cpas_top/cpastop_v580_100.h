...
static struct cam_camnoc_niu
	...
	},
	{
		...
		.maxwrclr_low = {
			...
			.access_type = CAM_REG_TYPE_WRITE,
			.masked_value = 0,
			.offset = 0x1428, /* IFE_RDI_WR_0_MAXWRCLR_LOW */
			.value = 0x1,
		},
	},
	{
		...
		.maxwrclr_low = {
			...
			.access_type = CAM_REG_TYPE_WRITE,
			.masked_value = 0,
			.offset = 0x7428, /* IFE_RDI_WR_1_MAXWRCLR_LOW */
			.value = 0x1,
		},
	},
	{
		...
		.maxwrclr_low = {
			...
			.access_type = CAM_REG_TYPE_WRITE,
			.masked_value = 0,
			.offset = 0x1A28, /* IFE_UBWC_STATS_0_MAXWRCLR_LOW */
			.value = 0x1,
		},
	},
	{
		...
		.maxwrclr_low = {
			...
			.access_type = CAM_REG_TYPE_WRITE,
			.masked_value = 0,
			.offset = 0x7628, /* IFE_UBWC_STATS_1_MAXWRCLR_LOW */
			.value = 0x1,
		},
	},
	{
...
static struct cam_camnoc_info cam580_cpas100_camnoc_info = {
	...
	.niu = &cam_cpas_v580_100_camnoc_niu[0],
	.num_nius = ARRAY_SIZE(cam_cpas_v580_100_camnoc_niu),
