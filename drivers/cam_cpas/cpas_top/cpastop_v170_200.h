...
static struct cam_camnoc_niu
	...
	},
	{
		...
		.maxwrclr_low = {
			...
			.access_type = CAM_REG_TYPE_WRITE,
			.masked_value = 0,
			.offset = 0x2428, /* IFE02_MAXWRCLR_LOW */
			.value = 0x1,
		},
	},
	{
		...
		.maxwrclr_low = {
			...
			.access_type = CAM_REG_TYPE_WRITE,
			.masked_value = 0,
			.offset = 0x2628, /* IFE13_MAXWRCLR_LOW */
			.value = 0x1,
		},
	},
	{
	...
	},
	{
		...
		.maxwrclr_low = {
			...
			.access_type = CAM_REG_TYPE_WRITE,
			.masked_value = 0,
			.offset = 0x2A28, /* IPE_BPS_LRME_MAXWRCLR_LOW */
			.value = 0x1,
		},
	},
	{
		...
		.maxwrclr_low = {
			...
			.access_type = CAM_REG_TYPE_WRITE,
			.masked_value = 0,
			.offset = 0x2C28, /* IPE_BPS_LRME_MAXWRCLR_LOW */
			.value = 0x1,
		},
	},
	{
...
static struct cam_camnoc_info cam170_cpas200_camnoc_info = {
	...
	.niu = &cam_cpas_v170_200_camnoc_niu[0],
	.num_nius = ARRAY_SIZE(cam_cpas_v170_200_camnoc_niu),
