...
static struct cam_vfe_bus_ver3_hw_info vfe_lite108x_bus_hw_info = {
	...
	.bus_client_reg = {
		/* BUS Client 0 RDI0 */
		{
			...
			.frame_incr               = 0x00009D08,
			.image_cfg_0              = 0x00009D0C,
			.image_cfg_1              = 0x00009D10,
			.image_cfg_2              = 0x00009D14,
			.packer_cfg               = 0x00009D18,
			.frame_header_addr        = 0x00009D20,
			.frame_header_incr        = 0x00009D24,
			.frame_header_cfg         = 0x00009D28,
			.line_done_cfg            = 0x00009D2C,
			.irq_subsample_period     = 0x00009D30,
			.irq_subsample_pattern    = 0x00009D34,
			.mmu_prefetch_cfg         = 0x00009D60,
			.mmu_prefetch_max_offset  = 0x00009D64,
			.system_cache_cfg         = 0x00009D68,
			.addr_cfg                 = 0x00009D70,
			.addr_status_0            = 0x00009D90,
			.addr_status_1            = 0x00009D94,
			.addr_status_2            = 0x00009D98,
			.addr_status_3            = 0x00009D9C,
			.debug_status_cfg         = 0x00009D7C,
			.debug_status_0           = 0x00009D80,
			.debug_status_1           = 0x00009D84,
		...
		/* BUS Client 1 RDI1 */
		{
			...
			.frame_incr               = 0x00009E08,
			.image_cfg_0              = 0x00009E0C,
			.image_cfg_1              = 0x00009E10,
			.image_cfg_2              = 0x00009E14,
			.packer_cfg               = 0x00009E18,
			.frame_header_addr        = 0x00009E20,
			.frame_header_incr        = 0x00009E24,
			.frame_header_cfg         = 0x00009E28,
			.line_done_cfg            = 0x00009E2C,
			.irq_subsample_period     = 0x00009E30,
			.irq_subsample_pattern    = 0x00009E34,
			.mmu_prefetch_cfg         = 0x00009E60,
			.mmu_prefetch_max_offset  = 0x00009E64,
			.system_cache_cfg         = 0x00009E68,
			.addr_cfg                 = 0x00009E70,
			.addr_status_0            = 0x00009E90,
			.addr_status_1            = 0x00009E94,
			.addr_status_2            = 0x00009E98,
			.addr_status_3            = 0x00009E9C,
			.debug_status_cfg         = 0x00009E7C,
			.debug_status_0           = 0x00009E80,
			.debug_status_1           = 0x00009E84,
		...
		/* BUS Client 2 RDI2 */
		{
			...
			.frame_incr               = 0x00009F08,
			.image_cfg_0              = 0x00009F0C,
			.image_cfg_1              = 0x00009F10,
			.image_cfg_2              = 0x00009F14,
			.packer_cfg               = 0x00009F18,
			.frame_header_addr        = 0x00009F20,
			.frame_header_incr        = 0x00009F24,
			.frame_header_cfg         = 0x00009F28,
			.line_done_cfg            = 0x00009F2C,
			.irq_subsample_period     = 0x00009F30,
			.irq_subsample_pattern    = 0x00009F34,
			.mmu_prefetch_cfg         = 0x00009F60,
			.mmu_prefetch_max_offset  = 0x00009F64,
			.system_cache_cfg         = 0x00009F68,
			.addr_cfg                 = 0x00009F70,
			.addr_status_0            = 0x00009F90,
			.addr_status_1            = 0x00009F94,
			.addr_status_2            = 0x00009F98,
			.addr_status_3            = 0x00009F9C,
			.debug_status_cfg         = 0x00009F7C,
			.debug_status_0           = 0x00009F80,
			.debug_status_1           = 0x00009F84,
		...
		/* BUS Client 3 RDI3 */
		{
			...
			.frame_incr               = 0x0000A008,
			.image_cfg_0              = 0x0000A00C,
			.image_cfg_1              = 0x0000A010,
			.image_cfg_2              = 0x0000A014,
			.packer_cfg               = 0x0000A018,
			.frame_header_addr        = 0x0000A020,
			.frame_header_incr        = 0x0000A024,
			.frame_header_cfg         = 0x0000A028,
			.line_done_cfg            = 0x0000A02C,
			.irq_subsample_period     = 0x0000A030,
			.irq_subsample_pattern    = 0x0000A034,
			.mmu_prefetch_cfg         = 0x0000A060,
			.mmu_prefetch_max_offset  = 0x0000A064,
			.system_cache_cfg         = 0x0000A068,
			.addr_cfg                 = 0x0000A070,
			.addr_status_0            = 0x0000A090,
			.addr_status_1            = 0x0000A094,
			.addr_status_2            = 0x0000A098,
			.addr_status_3            = 0x0000A09C,
			.debug_status_cfg         = 0x0000A07C,
			.debug_status_0           = 0x0000A080,
			.debug_status_1           = 0x0000A084,
		...
		{
			.cfg                      = 0x0000A100,
			.image_addr               = 0x0000A104,
			.frame_incr               = 0x0000A108,
			.image_cfg_0              = 0x0000A10C,
			.image_cfg_1              = 0x0000A110,
			.image_cfg_2              = 0x0000A114,
			.packer_cfg               = 0x0000A118,
			.frame_header_addr        = 0x0000A120,
			.frame_header_incr        = 0x0000A124,
			.frame_header_cfg         = 0x0000A128,
			.line_done_cfg            = 0x0000A12C,
			.irq_subsample_period     = 0x0000A130,
			.irq_subsample_pattern    = 0x0000A134,
			.mmu_prefetch_cfg         = 0x0000A160,
			.mmu_prefetch_max_offset  = 0x0000A164,
			.system_cache_cfg         = 0x0000A168,
			.addr_cfg                 = 0x0000A170,
			.addr_status_0            = 0x0000A190,
			.addr_status_1            = 0x0000A194,
			.addr_status_2            = 0x0000A198,
			.addr_status_3            = 0x0000A19C,
			.debug_status_cfg         = 0x0000A17C,
			.debug_status_0           = 0x0000A180,
			.debug_status_1           = 0x0000A184,
		...
		{
			.cfg                      = 0x0000A200,
			.image_addr               = 0x0000A204,
			.frame_incr               = 0x0000A208,
			.image_cfg_0              = 0x0000A20C,
			.image_cfg_1              = 0x0000A210,
			.image_cfg_2              = 0x0000A214,
			.packer_cfg               = 0x0000A218,
			.frame_header_addr        = 0x0000A220,
			.frame_header_incr        = 0x0000A224,
			.frame_header_cfg         = 0x0000A228,
			.line_done_cfg            = 0x0000A22C,
			.irq_subsample_period     = 0x0000A230,
			.irq_subsample_pattern    = 0x0000A234,
			.mmu_prefetch_cfg         = 0x0000A260,
			.mmu_prefetch_max_offset  = 0x0000A264,
			.system_cache_cfg         = 0x0000A268,
			.addr_cfg                 = 0x0000A270,
			.addr_status_0            = 0x0000A290,
			.addr_status_1            = 0x0000A294,
			.addr_status_2            = 0x0000A298,
			.addr_status_3            = 0x0000A29C,
			.debug_status_cfg         = 0x0000A27C,
			.debug_status_0           = 0x0000A280,
			.debug_status_1           = 0x0000A284,
			.comp_group               = CAM_VFE_BUS_VER3_COMP_GRP_0,
			.ubwc_regs                = NULL,
