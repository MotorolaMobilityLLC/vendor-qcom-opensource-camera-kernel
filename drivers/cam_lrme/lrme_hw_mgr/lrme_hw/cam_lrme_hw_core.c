...
static void cam_lrme_dump_registers(void __iomem *base)
{
	...
	cam_io_dump(base, 0x60, (0xc0 - 0x60) / 0x4, CAM_LRME, false);
	/* dump the fe and we registers */
	cam_io_dump(base, 0x200, (0x29c - 0x200) / 0x4, CAM_LRME, false);
	cam_io_dump(base, 0x2f0, (0x330 - 0x2f0) / 0x4, CAM_LRME, false);
	cam_io_dump(base, 0x500, (0x5b4 - 0x500) / 0x4, CAM_LRME, false);
	cam_io_dump(base, 0x700, (0x778 - 0x700) / 0x4, CAM_LRME, false);
	cam_io_dump(base, 0x800, (0x878 - 0x800) / 0x4, CAM_LRME, false);
	/* dump lrme sw registers, interrupts */
	cam_io_dump(base, 0x900, (0x928 - 0x900) / 0x4, CAM_LRME, false);
}
