...
#define CAM_CPAS_PATH_DATA_IFE_FULL (CAM_CPAS_PATH_DATA_IFE_START_OFFSET + 10)
#define CAM_CPAS_PATH_DATA_IFE_DS2 (CAM_CPAS_PATH_DATA_IFE_START_OFFSET + 11)
#define CAM_CPAS_PATH_DATA_IFE_DS4 (CAM_CPAS_PATH_DATA_IFE_START_OFFSET + 12)
#define CAM_CPAS_PATH_DATA_IFE_DS16 (CAM_CPAS_PATH_DATA_IFE_START_OFFSET + 13)
#define CAM_CPAS_PATH_DATA_IFE_RDI4 (CAM_CPAS_PATH_DATA_IFE_START_OFFSET + 14)
#define CAM_CPAS_PATH_DATA_IFE_PDAF_1 (CAM_CPAS_PATH_DATA_IFE_START_OFFSET + 15)
#define CAM_CPAS_PATH_DATA_IFE_PDAF_2 (CAM_CPAS_PATH_DATA_IFE_START_OFFSET + 16)
#define CAM_CPAS_PATH_DATA_IFE_PDAF_3 (CAM_CPAS_PATH_DATA_IFE_START_OFFSET + 17)
#define CAM_CPAS_PATH_DATA_IFE_IR (CAM_CPAS_PATH_DATA_IFE_START_OFFSET + 18)
#define CAM_CPAS_PATH_DATA_IFE_FD (CAM_CPAS_PATH_DATA_IFE_START_OFFSET + 19)
...
#define CAM_CPAS_PATH_DATA_OFE_WR_RAW       (CAM_CPAS_PATH_DATA_OFE_START_OFFSET + 12)
...
#define CAM_CPAS_PATH_DATA_IFE_PATH1 (CAM_CPAS_PATH_DATA_CONSO_OFFSET + 10)
#define CAM_CPAS_PATH_DATA_IFE_PATH2 (CAM_CPAS_PATH_DATA_CONSO_OFFSET + 11)
#define CAM_CPAS_PATH_DATA_IFE_PATH3 (CAM_CPAS_PATH_DATA_CONSO_OFFSET + 12)
#define CAM_CPAS_PATH_DATA_IFE_PATH4 (CAM_CPAS_PATH_DATA_CONSO_OFFSET + 13)
#define CAM_CPAS_PATH_DATA_IFE_PATH5 (CAM_CPAS_PATH_DATA_CONSO_OFFSET + 14)
